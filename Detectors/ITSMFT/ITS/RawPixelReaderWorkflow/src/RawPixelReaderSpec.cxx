	...
	namespace ITS
	{
		...
		//	}
			...
			if(Printed == 0 && differenceDecoder > 0 && difference > 0){
				...
				cout << "SUMMARY TIMING: TotalDigitDecoded = "  << mDigits.size() << "   Time Takes to Decode = "  << differenceDecoder/1000.0 << " s "  	<< "   Time Takes to Complete = "  << difference/1000.0 << " s " << "  Percentage = " << double(differenceDecoder/difference) << endl;
